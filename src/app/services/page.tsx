        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div className="relative h-96 w-full rounded-2xl overflow-hidden shadow-2xl min-h-[400px]">
              <img
                src="https://images.unsplash.com/photo-1541888946425-d81bb19240f5?q=80&w=3870&auto=format&fit=crop" // Replace with a relevant image (e.g., quarry, logistics fleet)
